...
class Feedback(models.Model):
    ...
    product_name= models.CharField(max_length=100,choices=PRODUCT_CHOICES, null=False, blank=False, default="All")
    user_feedback = models.TextField(null=True)
    published_date = models.DateTimeField(auto_now_add=True, null=True)
    ratings = models.CharField(max_length=100,choices=RATING_CHOICES, null=False, blank=False, default="All")
